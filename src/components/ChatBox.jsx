...
const ChatBox = () => {
  ...
  return chatUser ? (
    <div className="h-[75vh] relative bg-chatbox-bg">
      {/* Header */}
    ...
    <div className="w-full bg-black flex flex-col items-center justify-center gap-1 text-[#adadad]">
      <img className="w-14" src={assets.logo_icon} alt="" />
      <p className="text-xl font-semibold text-white">Chat anytime ,anywhere</p>
    </div>
  );
};
